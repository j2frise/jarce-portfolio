...
{
    const body = document.querySelector(".content-item-text");
    ...
    class Cursor {
        constructor(el) {
            ...
            this.DOM.arrows = {
                right: this.DOM.el.querySelector('.cursor-side-right'),
                left: this.DOM.el.querySelector('.cursor-side-left')
            };
    ...
    class Strip {
        constructor(el) {
            ...
            this.DOM.indicator = document.querySelector('.frame-indicator');
